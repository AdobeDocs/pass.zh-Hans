         ...
         <table style="table-layout:auto">
            ...
            <tr>
               ...
               <td>
                  拥有该配置文件的实体。<br/><br/>
                  可能的值包括：<ul>
                    <li><b>mvpd （例如，Spectrum、Cablevision等）</b><br/>创建配置文件的原因是：基本身份验证、使用平台标识的单点登录或使用服务令牌的单点登录。</li>
...
### &#x200B;2. 检索通过基本身份验证或使用服务令牌方法的单点登录获得的配置文件
...
### &#x200B;3. 检索通过基本身份验证或使用Platform Identity方法的单点登录获得的配置文件
