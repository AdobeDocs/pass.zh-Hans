...
|            | browserVersion | 否 | 设备的浏览器版本。 | e.g. 60.0.3112 |
...
|            | displayPpi | 否 | 设备的物理屏幕像素密度。 | e.g. 294 |
|            | 对角屏幕大小 | 否 | 设备的物理屏幕对角尺寸（英寸）。 | e.g. 5.5, 10.1 |
|            | connectionIp | 否 | 用于发送HTTP请求的设备的IP。 | e.g. 8.8.4.4 |
|            | connectionPort | 否 | 用于发送HTTP请求的设备的端口。 | e.g. 53124 |
