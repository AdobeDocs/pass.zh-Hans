...
* [将合作伙伴SSO配置文件交换为Adobe身份验证令牌](#step8)
* [Adobe令牌是否已成功生成？](#step9)
* [启动常规身份验证工作流](#step10)
* [继续授权流程](#step11)
...
#### 步骤“使用Adobe配置启动合作伙伴SSO工作流” {#step4}
...
#### 步骤：“将Adobe请求转发给合作伙伴SSO以获取配置文件” {#step7}
...
#### 步骤：“将合作伙伴SSO配置文件交换为Adobe身份验证令牌” {#step8}
