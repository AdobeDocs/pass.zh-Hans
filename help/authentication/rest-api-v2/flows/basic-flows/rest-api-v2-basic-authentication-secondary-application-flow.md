...
![使用预选的mvpd在辅助应用程序中执行身份验证](../../../assets/rest-api-v2/flows/basic-flows/rest-api-v2-perform-authentication-within-secondary-application-with-preselected-mvpd.png)
...
![在辅助应用程序中执行身份验证，无需预先选择mvpd](../../../assets/rest-api-v2/flows/basic-flows/rest-api-v2-perform-authentication-within-secondary-application-without-preselected-mvpd.png)
