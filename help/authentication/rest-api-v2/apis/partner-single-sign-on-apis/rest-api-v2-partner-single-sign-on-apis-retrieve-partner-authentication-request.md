               ...
               <td>
                  ...
                  <table>
                     ...
                     <tr>
                        ...
                        <td>该流设备可以使用所提供的合作伙伴验证请求来获得合作伙伴验证响应，该响应可被用于检索用户档案。</td>
                     </tr>
                     <tr>
                        <td style="background-color: #DEEBFF;">身份验证</td>
                        <td>
                            当合作伙伴单点登录流程无法继续时，流设备可以回退到基本身份验证流程。
                            <br/><br/>
                            流设备或其他设备需要在用户代理中打开提供的URL。
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td>
                            当合作伙伴单点登录流程无法继续时，流设备可以回退到基本身份验证流程。
                            <br/><br/>
                            流设备或其他设备需要提供缺少的参数并使用代码恢复身份验证会话。
                        </td>
                     </tr>
                     <tr>
                        <td style="background-color: #DEEBFF;">授权</td>
            ...
            <tr>
               ...
               <td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="background-color: #DEEBFF;">请求</td>
                            <td>SAML请求。</td>
                        </tr>
                        <tr>
