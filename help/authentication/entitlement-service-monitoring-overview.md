...
| eap | 通过外部系统执行身份验证流程时的外部身份验证提供程序。 </br> 值可以是： </br> - N/A — 身份验证由Adobe Pass身份验证提供 </br> - Apple — 提供身份验证的外部系统是Apple |
| os系列 | 设备上运行的操作系统 |
...
| sdk-version | Adobe Pass身份验证客户端SDK的版本 |
...
- **监控**  — 操作或监控团队可以创建每分钟调用API的功能板或图表。 使用显示的信息，他们可以在问题出现的一分钟就检测到问题(Adobe Pass身份验证或MVPD)。
