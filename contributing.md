...
此项目遵循该Adobe [行为准则](code-of-conduct.md). 参与此项目时，您应遵守本准则。 请将不可接受的行为报告给
...
所有提交都应采用拉取请求的形式，并且需要由项目提交者进行审核。 读取 [GitHub的拉取请求文档](https://help.github.com/articles/about-pull-requests/)
以了解有关发送拉取请求的更多信息。
